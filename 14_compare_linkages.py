...
# calculates false positives, false negatives.
...
# load gold standard data outside of loop
...
for filename in os.listdir(directory_path):
    ...
    if "deterministic" in filename:
        ...
        print(f"Time taken for processing {filename}: {iteration_duration} seconds")
...
data_df.to_csv(f"linkage_outputs\\scen{scenarios}\\dataset{data_set}\\20231128_dataset{data_set}_comparison.csv")
