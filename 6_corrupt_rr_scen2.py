# THIS ONLY APPLIES TO SCENARIO 2, WHERE WE ASSUMED CERTAIN PATTERNS TO BE PRESENT
# FOR SCENARIO 3 AND 4, WHERE WE ASSUMED A DIFFERENT PATTERN, A DIFFERENT CORRUPTION MECHANISM NEEDS TO BE USED!
...
path2 = os.path.join(directory, "accepted_sample_4.csv")
...
corrupted_df.to_csv('corrupted\\new_corrupted\\scen2_corrupt_combination1.csv')
...
# Concatenate all DataFrames in the list to create the final DataFrame
corrupted_df = pd.concat(corrupted_dfs, ignore_index=True)
corrupted_df.to_csv('corrupted\\new_corrupted\\scen2_corrupt_combination2.csv')
...
# Concatenate all DataFrames in the list to create the final DataFrame
corrupted_df = pd.concat(corrupted_dfs, ignore_index=True)
corrupted_df.to_csv('corrupted\\new_corrupted\\scen2_corrupt_combination3.csv')
...
# Concatenate all DataFrames in the list to create the final DataFrame
corrupted_df = pd.concat(corrupted_dfs, ignore_index=True)
corrupted_df.to_csv('corrupted\\new_corrupted\\scen2_corrupt_combination4.csv')
...
# Concatenate all DataFrames in the list to create the final DataFrame
corrupted_df.to_csv('corrupted\\new_corrupted\\scen2_corrupt_combination5.csv')


# Combine csvs to 1
file_paths = ['6June_batch\\6June_batch\\accepted_sample_4.csv','corrupted\\new_corrupted\\scen2_corrupt_combination1.csv', 'corrupted\\new_corrupted\\scen2_corrupt_combination2.csv','corrupted\\new_corrupted\\scen2_corrupt_combination3.csv','corrupted\\new_corrupted\\scen2_corrupt_combination4.csv', 'corrupted\\new_corrupted\\scen2_corrupt_combination5.csv']
...
appended_data['g1_dob_arc1'] = appended_data['g1_dob_arc1'].apply(format_days_to_date) 

appended_data.to_csv('corrupted\\new_corrupted\\20231027_file4_scen2_corrupted.csv', index=False)
