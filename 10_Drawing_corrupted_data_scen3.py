...
merged_df = pd.read_csv('output\\2023-10-22\\data_5_independent.csv')
...
condition_list = ["G1_sur_rand==1 & G1_fore_typo==1 & g0surname_error != 1",
"G1_sur_rand==1 & G1_fore_variant==1 & g0surname_error != 1",
"G0_sur_rand==1 & G1_fore_variant==1 & g1surname_error != 1",
"G0_sur_rand==1 & G1_sur_rand==1 & g1firstname_error != 1",
"G1_sur_rand==1 & g0surname_error != 1 & g1firstname_error != 1",
"G1_sur_ins==1 & g0surname_error != 1 & g1firstname_error != 1",
"G0_sur_ins == 1 & g1surname_error != 1 & g1firstname_error != 1",
"G1_fore_insdel==1 & g0surname_error != 1 & g1surname_error != 1",
"G1_fore_rand==1  & g0surname_error != 1 & g1surname_error != 1",
"G1_fore_typo==1  & g0surname_error != 1 & g1surname_error != 1",
"G1_sur_del==1 & g0surname_error != 1 & g1firstname_error != 1",
"G0_sur_del==1 & g1surname_error != 1 & g1firstname_error != 1",
"G0_sur_rand==1 & g1surname_error != 1 & g1firstname_error != 1",
"G1_fore_variant==1  & g0surname_error != 1 & g1surname_error != 1",
"g0surname_error != 1 & g1surname_error != 1 & g1firstname_error != 1"]
sample_sizes = [40,93,100,299,199,13,40,93,80,146,20,60,1493,776,9829]

# conditions_list = ["g0surname_error == 1  & g1surname_error != 1 & g1firstname_error != 1","g0surname_error != 1  & g1surname_error == 1 & g1firstname_error != 1","g0surname_error != 1  & g1surname_error != 1 & g1firstname_error == 1"]
# sample_sizes = [1593, 232, 1095]

sampled_df = multi_sample_data6(df2, condition_list, sample_sizes)
print(sampled_df)
...
sampled_df.to_csv('corrupted//scen3//20231027_data5.csv', encoding = "utf-8-sig")
